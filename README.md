...
Educational pretty printer of TLS details and support for PQC.

Built with Claude Code (using forrestchang/andrej-karpathy-skills).
...
```
example.com    TLS 1.3  AES-256-GCM  256  ~ Hybrid Ready
google.com     TLS 1.3  AES-256-GCM  256  ~ Hybrid Ready
legacy.old     TLS 1.2  AES-128-CBC  128  ✗ Not Ready
```
